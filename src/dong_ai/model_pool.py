...
PROVIDERS = {
    ...
    "openrouter": {
        ...
        "models": ["openai/gpt-4o", "anthropic/claude-sonnet-4", "google/gemini-2.0-flash", "deepseek/deepseek-v4"],
        "provider_type": "openai",
    },
    "kimi": {
        "name": "Kimi / Moonshot",
    ...
    "minimax": {
        ...
        "models": ["MiniMax-Text-01", "MiniMax-T2A"],
        "provider_type": "openai",
    },
    "xai": {
        "name": "xAI / Grok",
    ...
    "huggingface": {
        ...
        "env_key": "HF_TOKEN",
        "models": ["meta-llama/Llama-3.3-70B", "Qwen/Qwen2.5-72B-Instruct"],
        "provider_type": "openai",
    },
    # === 热门开源/免费 API ===
    "groq": {
    ...
    "together": {
        ...
        "models": ["meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo", "meta-llama/Meta-Llama-3.1-8B-Instruct"],
        "provider_type": "openai",
    },
    "fireworks": {
        "name": "Fireworks AI",
